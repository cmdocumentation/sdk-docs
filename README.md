...
- Lessons learned: Keep examples minimal and environment-driven, support sandbox/stub mode for CI, sanitize logs and recordings to avoid leaking tokens, and prefer small dependencies so examples run quickly for newcomersz.
